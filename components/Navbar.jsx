...
const solutions = [
    {
        name: 'Pengumuman',
        description: 'Dapatkan pengumuman informasi seputar PPDB Sumatera Barat.',
        href: '/sekolah',
        icon: ChartBarIcon,
    },
    {
        name: 'Jadwal',
        description: 'Update seputar jadwal PPDB Sumatera Barat.',
        href: '/about',
        icon: CursorClickIcon,
    },
    { name: 'Sekolah', description: "Data sekolah yang berpatisipasi pada PPDB Sumatera Barat.", href: '/sekolah', icon: ShieldCheckIcon },
    {
        name: 'Integrations',
...
const resources = [
    ...
    { name: 'Security', description: 'Understand how we take your privacy seriously.', href: '/about', icon: ShieldCheckIcon },
]
const recentPosts = [
    { id: 1, name: 'Boost your conversion rate', href: '/about' },
    { id: 2, name: 'How to use search engine optimization to drive traffic to your site', href: '/about' },
    { id: 3, name: 'Improve your customer experience', href: '/about' },
]
...
export default function Navbar() {
    return (
        ...
        //             <div className="">
        //                 <Link href="/about">
        //                     <a className="text-blue-500 font-semibold hover:text-blue-700 py-5  px-3" >
        //                         Beranda
        //                     </a>
        //                 </Link>
        //                 <Link href="/about">
